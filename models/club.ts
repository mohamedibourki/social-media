...
const clubSchema = new Schema(
	{
		...
		president: { type: Types.ObjectId, ref: "Student", required: true },
		vicePresident: { type: Types.ObjectId, ref: "Student" },
		members: [{ type: Types.ObjectId, ref: "Student" }],
		supervisor: { type: Types.ObjectId, ref: "Admin", required: true },
